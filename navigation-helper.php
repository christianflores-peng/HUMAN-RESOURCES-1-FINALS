    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="user-info">
                ...
                <a href="login.php" style="color: #3b82f6;">Login</a> | 
        ...
        <div class="nav-grid">
            ...
            <div class="nav-section">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="login.php">Login <span class="status status-public">Public</span></a></li>
                    <li><a href="register.php">Register <span class="status status-public">Public</span></a></li>
