...
<script>
    ...
    // Attach to all nav links and forms
    document.addEventListener('DOMContentLoaded', function() {
        // Show loading on nav link clicks
        document.querySelectorAll('a.nav-link:not([href="#"]):not([href^="javascript"])').forEach(function(link) {
        ...
        document.querySelectorAll('form.show-loading').forEach(function(form) {
